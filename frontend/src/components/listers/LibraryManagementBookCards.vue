    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <LibraryManagementBook :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <LibraryManagementBook :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import LibraryManagementBook from './../LibraryManagementBook.vue';

    export default {
        name: 'LibraryManagementBookManager',
        components: {
            LibraryManagementBook,
        },
        props: {
            offline: Boolean
        },
