            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="bookHistories"
                        to="/libraryManagements/bookHistories"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="loanSummaries"
                        to="/loanManagements/loanSummaries"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '도서 이력', 
                description: 'BookHistory을 관리하는 화면입니다.', 
                key: 'bookHistories', 
                route: '/libraryManagements/bookHistories',
                ImageUrl: '',
            },
            { 
                title: '대출 목록', 
                description: 'LoanSummary을 관리하는 화면입니다.', 
                key: 'loanSummaries', 
                route: '/loanManagements/loanSummaries',
                ImageUrl: '',
            },
            { 
                title: '대출 상세', 
